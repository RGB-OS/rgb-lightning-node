...
use crate::routes::{
    ...
    get_asset_media, get_channel_id, get_payment, get_payment_preimage, get_swap, init,
    invoice_cancel, invoice_hodl, invoice_settle, invoice_status, issue_asset_cfa, issue_asset_nia,
    ...
    revoke_token, rgb_invoice, send_asset, send_btc, send_onion_message, send_payment, shutdown,
